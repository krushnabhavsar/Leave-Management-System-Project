...
<!--<html>
	...
	<body>
		...
		<input type ="button" button class="button button3 active" onclick="window.location='s_changepassform.php';" value='Change Password'>
		...
		<div id="changepass">
		<form action="s_changepass.php" width="auto" method="post" >
		<fieldset>
		<table align="center">
		<tr>
